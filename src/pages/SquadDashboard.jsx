...
import { Users, Vote, Trophy, Copy, Check, Sparkles, TrendingUp, Target, Zap } from 'lucide-react';
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500">{squad.members.length} personas en el equipo</p>
            </div>
          </div>
        </div>
              ...
              <div
                ...
                className={`relative overflow-hidden rounded-2xl p-4 transition-all hover:shadow-lg ${
                  isCurrentUser
                    ...
                    : 'bg-gradient-to-br from-neutral-50 to-white border-2 border-transparent'
                }`}
              >
