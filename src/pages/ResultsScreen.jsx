...
const ResultsScreen = ({ squad, currentUser }) => {
  ...
  return (
    <div className="min-h-screen p-6 max-w-md mx-auto pb-24">
      ...
      {currentUserResult && currentUserResult.votesReceived.length > 0 && (
        <div className="card bg-gradient-to-br from-purple-500 to-pink-500 text-white border-none mb-6">
          ...
          <div key={result.member.id} className="card">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-shrink-0">
                <div className="w-14 h-14 bg-gradient-to-br from-purple-400 to-pink-500 rounded-2xl flex items-center justify-center text-white text-xl font-bold">
